  ...
  return (
    ...
    <div className="container m-auto px-6 md:px-12 lg:px-6">
        ...
        <div className=" absolute">
                <svg xmlns="http://www.w3.org/2000/svg" width="95" height="153" viewBox="0 0 95 153" fill="none" className="lg:h-128 lg:block  lg:relative md:-top-16 lg:-top-12 xl:-top-24 2xl:-top-48  lg:left-64 hidden">
